            ...
            async for chunks in graph.astream(initial_state, stream_mode="updates"):
                for node_name, state_update in chunks.items():
                    ...
                    if node_name == "chat_model":
                        ...
                        #     final_response = make_error_response(
                        #         user_query=user_query,
                        #         status="empty_chat_model_response",
                        #         summary="chat_model returned no tool calls and no text content.",
                        #         errors=[
                        #             "The worker LLM did not produce tool_calls. routing_node ended the graph before tools/deterministic_final."
                        #         ],
                        #         tools_used=tools_requested,
                        #     )
...
#                         last_message = messages[-1]
#                         print_ollama_metadata(last_message)
